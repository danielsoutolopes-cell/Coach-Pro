...
export default function ProximoTreinoScreen() {
  ...
  const details = parseDetails(nextSession?.details_json);
        ...
        <View style={s.card}>
          ...
          {nextSession ? (
            <>
              ...
              {(nextSession.pace_target || nextSession.rest_interval || nextSession.treadmill_speed || bikeMin || volBody) && (
                <Text style={s.meta}>
                  ...
                  {(nextSession.pace_target || nextSession.rest_interval || nextSession.treadmill_speed) && bikeMin ? " · " : ""}
                    ...
                    return (
                      <View key={b.key} style={{ borderWidth: 1, borderColor: colors.border, borderRadius: 10, padding: 10 }}>
                        ...
                        <View style={{ marginTop: 6, gap: 4 }}>
                          {list.slice(0, 12).map((seg: any, idx: number) => (
